...
export default function RevolutionalizeServices() {
    ...
    return (
        <div className="custom-container pb-3 bg-[url(/revolutionize/hill-shape.png)] bg-no-repeat bg-cover mx-auto pt-20 mt-30 relative w-[calc(100%-10px)] md:w-[calc(100%-20px)] rounded-xl px-2 ">
