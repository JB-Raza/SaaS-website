  ...
  return (
    <div className="grid grid-cols-12 gap-16 pt-72 pb-36 overflow-clip">
              ...
              <div className="col-span-12 sm:col-span-8 md:col-span-6 flex justify-center flex-col gap-7 !px-3">
                ...
                <h1 className="text-white capitalize hero-heading font-semibold">Simplify task <span className='italic font-normal text-gradient-teal'>management</span> and prioritize work</h1>
                <p className="text-white text-[18px] font-normal leading-loose">Sassly-<span className='text-amber-400'>CRM</span> in the past allowing you to focus more on your business or simply enjoy your newfound legal time to reflect leaving</p>
    
                <Button content={"Start Free Trial"} icon={"fa-solid fa-cloud-arrow-down"} className={" w-[240px] py-5 text-white bg-[linear-gradient(270deg,_#06766E_0%,_#20BA8B_100%)]"} />
