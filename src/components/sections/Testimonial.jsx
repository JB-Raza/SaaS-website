...
export default function Testimonial() {
    return (
        <div className="grid max-w-[1200px] bg-[#06766E] grid-cols-12 py-15 px-3 sm:px-6 mx-auto w-[calc(100%-10px)] sm:w-[calc(100%-30px)] rounded-xl">
            ...
            >
                {/* slide 1 */}
                <SwiperSlide className="!flex flex-col gap-7 items-start px-2 sm:px-4 md:pe-15">
                    <img src="./testimonial/ratings.svg" alt="" />
                    <p className="heading-4 line-clamp-3 font-normal text-neutral-100 text-wrap">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto aspernatur illo animi laboriosam dolorum veritatis officia quis dolorem quos distinctio.</p>
                    <hr className="border-t-[1px] border-white/20 mt-5 w-full" />
                    <div className="card flex gap-7 items-center bg-white/10 px-7 py-2">
                        <img src="./testimonial/client-img.png" alt="client" />
                        <div>
                            <h5 className="text-[20px] font-semibold text-white">Tom Hiddleson</h5>
