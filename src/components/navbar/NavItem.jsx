...
export default function NavItem({ navTitle, dropdownItems, className, index, isOpen, setIsOpen }) {
    ...
    return (
        <li
            ...
            className={`relative transition-all duration-300 h-[60px] ${isOpen ? "h-auto" : ""} lg:py-6 lg:h-[100%] flex flex-col lg:flex-row items-center font-semibold cursor-pointer group text-base`}>
            ...
            {/* dropdown */}
            <ul className={`h-[0px] overflow-clip transition-all duration-400 !py-0 px-2 ${isOpen ? "w-full !block h-full" : "w-full"}
