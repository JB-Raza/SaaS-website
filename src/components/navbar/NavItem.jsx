...
export default function NavItem({ navTitle, dropdownItems, className, active }) {
    ...
    return (
        <li
            ...
            {/* dropdown */}
            <ul 
            className={`hidden h-[0px] ${isOpen? "h-auto absolute left-0 right-0 !w-[100%] !block ":""}
            lg:block lg:absolute  min-w-[190px] top-[100%] left-0 lg:opacity-0 lg:invisible lg:group-hover:opacity-100 lg:h-auto lg:group-hover:visible bg-white text-black shadow-lg rounded-md p-2 mt-1 z-50 transition duration-300 ease-out 
