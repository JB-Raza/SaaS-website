        ...
        <div>
            ...
            <section className="bg-[var(--iceBlue)]">
                <div className="custom-container mx-auto pt-[270px] pb-[170px] flex flex-col items-center gap-1.5">
                    ...
                    <h1 className="animate-contact-heading heading-1 capitalize font-bold text-center">Sign In</h1>
                </div>
            </section>
            ...
            <div className="custom-container mx-auto py-35 px-3">
                <form className="rounded-xl shadow-2xl py-6 px-2 sm:px-6 max-w-[514px] mx-auto bg-white">
                    ...
                    {/* name */}
                    <InputBox type='text' name={"name"} id={"name"} label={"Enter your name"} />
                    <InputBox type='password' name={"password"} id={"password"} label={"Create Password"} />
