...
export default function AppIntegration() {
    ...
    useTextAnimate(".animate-app-integration-text")

    return (
        <div>
            <section className="bg-[var(--bgIceBlue)] py-[224px]">
                <div className="custom-container mx-auto py-[64px]">
                    <h1 className="animate-app-integration-text heading-1 text-center font-semibold mt-10 leading-10 capitalize">app integrations</h1>
                    <p className="animate-app-integration-text text-center text-neutral-500 max-w-[500px] mx-auto mt-10 leading-loose">Create tasks with various custom statuses to focus more on your keeptrack of the progress of each why</p>
            ...
            <section className="custom-container mx-auto py-20">
                <h3 className="animate-app-integration-text heading-3 text-center capitalize font-bold max-w-[600px] mx-auto">Seamless Integration for enhancing experience</h3>
                <p className="animate-app-integration-text text-center text-neutral-500 max-w-[500px] mx-auto mt-4 leading-loose">Create tasks with various custom statuses to focus more on your keeptrack of the progress of each why</p>
            ...
            <section className="bg-[var(--bgIceBlue)] py-[115px] my-10">
                <div className="custom-container mx-auto">

                    <p className='animate-app-integration-text text-center max-w-[160px] py-1 mx-auto font-medium bg-white border border-green-400 rounded-full text-gradient-teal'>What we offering</p>
                    <h3 className="animate-app-integration-text heading-3 text-center capitalize leading-15 font-bold max-w-[640px] mt-7 mx-auto">Trusted by <span className='text-gradient-teal'>3+ million</span> website owners worldwide</h3>
            ...
            <div className="custom-container py-30 mx-auto">
                ...
                <h3 className="animate-app-integration-text max-w-[690px] px-2 mx-auto heading-3 text-center font-semibold mt-10 leading-10 capitalize">Driven your business today next level by sasstech</h3>
            ...
            <div className="custom-container verflow-hidden mx-auto py-30">
                <div className="grid grid-cols-12 gap-20 px-3">
                    {/* col 1 */}
                    <div className="col-span-12 md:col-span-5 flex flex-col gap-4 items-start">
                        <p className="animate-app-integration-text bg-neutral-100 py-2 px-4 font-medium rounded-full">Up to <span className='text-yellow-500'>70%</span> off managed cloud hosting</p>
                        <h3 className="animate-app-integration-text heading-3 font-bold capitalize">Frequently ask <span className='font-normal italic'>Questions</span></h3>
                        <p className="animate-app-integration-text text-neutral-500 max-w-[330px] mt-3 leading-loose">Create tasks with various custom statuses to focus more on your keep track of the progress of each why in</p>
